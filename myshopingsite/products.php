			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Camera 2</h3>
							<p>Price: <i class="fa fa-rupee"></i> 70,0000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Camera 3</h3>
							<p>Price: <i class="fa fa-rupee"></i> 75,0000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Camera 4</h3>
							<p>Price: <i class="fa fa-rupee"></i> 65,0000</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Shirt 2</h3>
							<p>Price: <i class="fa fa-rupee"></i> 630</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Shirt 3</h3>
							<p>Price: <i class="fa fa-rupee"></i> 670</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						<img src="img/shit2.png" alt="shirt">
						<div class="caption">
							<h3>Shirt 4</h3>
							<p>Price: <i class="fa fa-rupee"></i> 680</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
			...
			<div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Watch 2</h3>
							<p>Price: <i class="fa fa-rupee"></i> 980</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
				...
				<div class="col-md-3 col-sm-6">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Watch 4</h3>
							<p>Price: <i class="fa fa-rupee"></i> 880</p>
							<?php if(!isset($_SESSION["email_id"])){ ?>
							<a href="login.php" type="button" class="btn btn-primary">Add to cart</a>
							<?php }else{ ?>
